...
| 47 (bonus) | MCP authorization — OAuth 2.1 + PKCE, own AS+RS on `/mcp` | 48 (next, bonus) | MCP session-scoped authorization + agent-identity audit |
